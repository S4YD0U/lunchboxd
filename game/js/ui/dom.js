...
// ─── Navigation ──────────────────────────────────────────────────────────────
const ALL_SCREENS = ['map','select','shop','skills','loadout','battle','victory','pvp'];
...
export function showScreen(name) {
  ...
  ['map','shop','skills','loadout','pvp'].forEach(t => { const b = $('tab-'+t); if(b) b.classList.remove('active'); });
  if (['map','select','shop','skills','loadout','pvp'].includes(displayName)) {
